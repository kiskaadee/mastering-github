# GitHub Actions CI/CD: GitHub Actions for Infrastructure Deployment (Bicep)

## 1. Course Information
* **Course:** Learning GitHub Actions for DevOps CI/CD
* **Module:** 04 - GitHub Actions for Infrastructure Deployment (Bicep)
